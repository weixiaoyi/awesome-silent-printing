...
>
> 同时覆盖：`window.print` 限制、Chrome 访问 `127.0.0.1`、Vue/React 静默打印、HTML/CSS 打印、Lodop 替代、QZ Tray / web-print-pdf / JSPrintManager 对比、批量面单与远程打印。
...
实用长文说明。完整目录：[docs/](docs/README.md)。

- [浏览器静默打印总览](docs/browser-silent-print.zh-CN.md)
- [静默打印如何工作](docs/how-silent-printing-works.zh-CN.md)
- [如何选型静默打印方案](docs/choose-silent-print-stack.zh-CN.md)
- [window.print 与静默打印](docs/window-print-vs-silent-print.zh-CN.md)
- [Chrome 本地网络访问与 127.0.0.1](docs/chrome-local-network-access.zh-CN.md)
- [Vue / React 静默打印](docs/vue-react-silent-print.zh-CN.md)
- [用 HTML/CSS 做静默打印](docs/html-css-silent-print.zh-CN.md)
- [网页批量 / 面单打印](docs/batch-label-printing.zh-CN.md)
- [远程 / 服务端推送静默打印](docs/remote-silent-print.zh-CN.md)
- [QZ Tray、web-print-pdf、JSPrintManager 对比](docs/qz-vs-jspm-vs-web-print-pdf.zh-CN.md)
- [Lodop 替代方案](docs/lodop-alternatives.zh-CN.md)
- [hiprint 替代方案](docs/hiprint-alternatives.zh-CN.md)
- [QZ Tray 替代方案](docs/qz-tray-alternatives.zh-CN.md)
- [JSPrintManager 替代方案](docs/jsprintmanager-alternatives.zh-CN.md)
- [浏览器热敏小票静默打印](docs/thermal-receipt-silent-print.zh-CN.md)
...
LNA 影响的是**所有**走本机回环的打印桥接（QZ、web-print-pdf、JSPM、各类本地服务等），不是某一家独有。更细的排查说明见：[上线后 WebSocket 连接 127.0.0.1 失败](https://webprintpdf.com/docs/production-print-troubleshoot/)。
...
1. **要成熟的全球 POS / raw + 像素打印生态** → [QZ Tray](https://qz.io/)、[JSPrintManager](https://www.neodynamic.com/products/printing/js-print-manager/)。
2. **在 SPA（Vue / React 等）里用 HTML/CSS 打业务单据** → 对比能接 HTML/PDF 的本地桥接，例如 QZ Tray、[web-print-pdf（Web Print Expert）](https://webprintpdf.com/)、JSPrintManager、[Lodop / C-Lodop](http://www.c-lodop.com/)、[electron-hiprint](https://github.com/CcSimple/electron-hiprint)。
3. **已经在用遗留打印控件** → 先继续评估 Lodop / hiprint；只有系统覆盖或 SPA 接入成瓶颈时再迁。
4. **Linux 桌面（含麒麟 / UOS 等发行版）** → 优先有真实 Linux 客户端的方案（QZ Tray、web-print-pdf、JSPrintManager 等）。
...
| [Zebra Browser Print](https://www.zebra.com/us/en/support-downloads/software/printer-software/browser-print.html) | ✅ | ✅ | — | ✅ | ⚠️ 样例 / 本地 | — | 图片 | ZPL/raw | 有限 | — |
...
| [web-print-pdf（Web Print Expert）](https://webprintpdf.com/) | ✅ | ✅ [demo](https://webprintpdf.com/docs/demos/) | ✅ `web-print-pdf` | ✅ | ✅ | ✅ | HTML/CSS | 中偏低 | 装客户端 |
...
| [Zebra](https://www.zebra.com/us/en/support-downloads/software/printer-software/browser-print.html) / [Epson](https://download.epson-biz.com/) / [Star](https://star-m.jp/products/s_print/sdk/webprnt/manual/en/index.htm) SDK | ✅ | ⚠️ 厂商样例 | 厂商脚本 | 不一 | 否 | 需自行封装 | 设备指令集 | 跟硬件走 | 厂商栈 |
...
按载荷（HTML 还是 raw）、系统覆盖、签名 / 授权成本对照选型即可。表内符号仅供速览，请以各官方文档为准。
...
- [Zebra Browser Print](https://www.zebra.com/us/en/support-downloads/software/printer-software/browser-print.html) — 面向 Zebra 的浏览器打印（本机服务 + JS）。
- [Epson ePOS SDK for JavaScript](https://download.epson-biz.com/) — 网页经网络驱动 Epson TM。
...
- [web-print-pdf（Web Print Expert）](https://webprintpdf.com/) — 本地客户端，可选远程拉任务。
...
| 日本語 | [README.ja.md](README.ja.md) | 已完成 |
| Español | [README.es.md](README.es.md) | 已完成 |
| Português (Brasil) | [README.pt-BR.md](README.pt-BR.md) | 已完成 |
| 한국어 | [README.ko.md](README.ko.md) | 已完成 |
| Deutsch | [README.de.md](README.de.md) | 已完成 |
| Русский | [README.ru.md](README.ru.md) | 已完成 |

`docs/` 下长文已覆盖全部 README 语言。
