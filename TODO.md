...
Tracked work for **awesome-silent-printing**. Check items off as they ship.

## i18n — language switching (required)

All languages below must be reachable from the top language switcher on every README.
